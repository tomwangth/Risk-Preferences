...
result_list = Receive_Data().open_file("Holt_Laury_Output test4 copy.csv")
...
class DataFrame(object):
    def __init__(self):
        self.result_list = Receive_Data().open_file("Holt_Laury_Output test4 copy.csv")
...
class Hit_Calculator(object): # this needs to be fixed, together with mTree
    def __init__(self):
        ...
        self.df2 = None
        self.theta  =[]
        self.hit_rate_list = [] # this is a list of hit rate
